...
data2 = {
  ...
  '생년월일' : [ '1999-03-15', '1993-07-22', '1995-01-10', '1988-11-02', '1996-06-18', ],
}

# 데이터프레임으로 변환 후 첫번째 컬럼인 '이름을 인덱스로 지정
...
# sheet를 지정한 후 저장시에는 _save함수를 추가로 실행
writer._save() # 정석: writer.close()
...
""" 
개발자가 정의하는 예외클래스
: 예외클래스 정의 시 Exception 클래스를 상속하고 생성자에서
예외발생 시 출력한 에러 메세지를 정의한다.
"""
print('실행7')
# 파이썬에서는 상속 시 extends를 사용하지 않고, 매개변수 형태로 상속받음.

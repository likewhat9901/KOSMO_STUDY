...
하지만 클래스변수와 정적함수는 인스턴스 내부에 존재하지 않고 별도의 메모리에
독립적으로 생성된다. 따라서 2개 이상의 인스턴스를 생성해도 딱 하나만 생성되어
모든 인스턴스가 공유하게 된다.
"""
class MyCalculator:

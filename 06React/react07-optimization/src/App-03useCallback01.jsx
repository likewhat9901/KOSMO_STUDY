...
function App() {
  ...
  /* Step1 : 일반적인 화살표 함수 선언
    State 변경에 의해 App 컴포넌트가 새롭게 리렌더링 되면 이 함수는
    그때마다 새로운 참조값을 할당받게 된다. 즉, 참조값이 계속 바뀌므로
    useEffect가 지속적으로 실행된다. JavaScript에서 함수는
    객체이기 때문이다. */
  /* const somethingGood = () => {
  ...
  State의 변경을 감지하지 못한다. 최초 실행시의 초기값 0만 출력된다. */  

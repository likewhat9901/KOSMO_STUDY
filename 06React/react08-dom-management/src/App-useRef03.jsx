...
function App() {
  ...
  첫번째 렌더링 후 useEffect가 실행되고, 내부에서 다시 State가 변경되므로
  ...
  /* Step2 : 만약 이 상황에 일반변수를 사용하면 렌더링 될때마다 0으로
  초기화되므로 횟수를 알 수 없게 된다. 따라서 변화는 감지해야 하지만
  렌더링은 안되야 하는 상황에 useRef는 유용하게 사용된다. */

...
props(프롭스)
  ...
  전달하는 읽기전용 데이터를 말한다. 전달 시에는 HTML의 속성처럼 기술한다.
  형식]
    <컴포넌트 props속성명={전달할값} />
...
/* 전달되는 인수를 매개변수에서 바로 구조분해하여 필요한 프롭스만
직접 추출하는 방식을 사용한다. 프롭스명을 자식 컴포넌트에서 그대로 사용할 수 있다.
...
function App() {
  ...
  const backData = ['Java', 'Oracle', 'JSP', 'Spring', 'Nextjs추가'];

...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<!-- Tomcat8 이전에 사용되는 지시어. http로 시작하는 uri 사용. -->
<%--@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" --%> <!-- 예전꺼 -->
...
4가지 영역에 속성을 저장한다.
	var : 속성명(변수명)을 지정.
	value : 속성에 저장할 값.
	scope : 4가지 영역명을 지정. 생략 시 page영역이 지정됨
...
-->
	...
	<c:set var="personVar1" value='<%= new Person("박문수", 50) %>'
		scope="request" />
	<!-- 
	자바빈의 getter 메서드를 통해 멤버변수의 값이 출력된다. -->
	<ul>

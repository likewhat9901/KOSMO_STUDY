...
/*
 * static 블럭
 * : 동일 클래스 내 main() 메서드보다 먼저 실행되는 블럭으로 main() 메서드의 실행코드가
 * 없어도 먼저 실행된다. 또한 생성자보다도 먼저 실행되는 특징이 있다.
 */
public class E02StaticBlockMain {
	...
	static {
		...
		/*
		 * 블럭내에서만 사용할 수 있는 변수로써, 블럭 내에서는 일반변수를 생성할 수 있다.
		 */
		int localVar;
		localVar = 1000;
...
//		instanceMethod(); //에러
	...
	public static void main(String[] args) {
		...
		/*
		 * static 블럭내에서 선언된 변수는 지역변수이므로 main메서드에서는 사용할 수 없다.
		 * static 블럭 지역 내에서만 사용할 수 있다.
		 */

...
public class E02SilsuType {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 - 소수점이 있는 데이터를 float에 대입하려면 접미사(F,f)를 붙여야 함.
		 */
		float f3 = 100;
		//float f4 = 3.14;
		/*
		 - 에러발생. 3.14 자체를 double로 인식하기 때문.
		 - 강제 형변환 후 대입할 수 있으나 권장하지 않음.(double풀에서 삭제 후 float풀로 다시 입력하는 과정이기 때문)
		 - 접미사를 통해 float형 자료임을 명시하는 것이 권장사항.
		 */
		float f4 = (float)3.14;
		...
		//float보다 double이 더 크므로 연산결과는 double.
		double d1 = 3.14;
		double d2 = f6 + d1;

...
/*
 public 클래스는 해당 java 파일을 대표하는 클래스로 파일명과 반드시 동일해야 한다.
 또한 public 클래스는 자바 파일당 단 하나만 정의할 수 있다.
 public으로 정의하는 경우 다른 패키지에서도 접근을 허용하게 되므로 하나의 java파일에
...
public class E01AccessModifier1 {
	...
	public void publicMethod() {
		...
		/*
		 private으로 선언된 메서드로 클래스 내부에서는 호출할 수 있다.
		 멤버변수와 동일한 접근범위를 가진다.
		 */
		privateMethod();
	}

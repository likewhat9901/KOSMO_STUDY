...
/*
 switch문
 - if 문처럼 조건에 따라 분기하는 제어문으로 정수식의 값과 동일한 부분을 찾아 실행하는 형태
 - 형식
	 switch(산술식 or 정수식){
	 	case 값:
	 		실행문; break;
...
//		}
		...
		// switch문에 조건식을 사용할 수 없으므로, 평균점수를 10으로 나눈 몫을 통해 조건구간을 구한다.

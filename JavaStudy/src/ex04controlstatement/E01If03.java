...
/*
 if문 형식3
 	if(조건1){
 		...
 		위 모든 조건에 만족하지 않는 경우 실행;
 	}
 	단, else문에 조건식이 들어가면 에러 발생. 주의
 */
public class E01If03 {
	...
	public static void main(String[] args) {
		...
		// 점수는 정수타입(int)으로 변수 및 초기값 할당
		int kor = 99, eng = 70, math = 64;
		/*
		 평균값은 소수점이 될 수 있으므로 실수형(double)으로 선언하는 것이 좋다.
		 double형의 결과를 얻기 위해 3.0으로 나눠줌.
		 */
		double avg = (kor + eng + math) / 3.0;
		
		System.out.println("평균점수는(그대로):" + avg);
		// 서식문자를 이용해서 소수 이하 2자리까지만 표현
		...
		/*
		 ...
		 이와 같이 구간이 필요한 경우, 큰 숫자를 먼저 기술해야 함.
		 */
		if (avg >= 60) {
			System.out.println("D학점");
		}else if (avg >= 70) {

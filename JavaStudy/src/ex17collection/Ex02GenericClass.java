...
public class Ex02GenericClass {
	...
	public static void main(String[] args) {
		 ...
		 * 컴파일 에러가 발생하므로 실행 자체가 불가능하다. 즉, 자료형에는 안전하지만,
		 * 구현에는 불편함이 있다. 다른 인스턴스를 저장하기 위해서는 또다른 Box클래스를 생성해야한다.
		 */
...
//		oBox1.store("당도가 20인 오렌지");
		...
		/*
		 * Object를 기반으로 생성된 FruitBox는 구현에는 편리하나 코드레벨에서 에러가
		...
		/*
		 * 하지만 오렌지 같은 String을 저장하고, 이를 꺼내서 다운캐스팅하는 과정에서 예외가
		 * 발생된다. 즉 런타임 에러가 발생하게되므로 실행전에는 오류를 예측하기 힘든 단점이 있다.
		 */

...
public class Ex03ArrayList2 {
	...
	public static void main(String[] args) {
		 ...
		 * 인스턴스 생성시 Student형의 타입매개변수를 통해 생성한다. Student를
		 * 저장할 수 있는 상자가 된다.
		 */
...
//		ArrayList<Student> list2 = new ArrayList<Student>();
		...
		/*
		 * 저장할 Student 인스턴스 생성. 외부패키지에 선언되었으므로 import 후 
		 * 사용할 수 있다.
		 */
		...
		/*
		 * 인스턴스의 참조값을 통해 삭제하는 경우 boolean값이 반환된다. 또한 동일한 인스턴스가
		 * 존재한다면 앞에서부터 순서대로 삭제된다. 즉, 동시에 삭제되지 않는다.
		 */
		...
		/*
		 * List에 저장된 값을 통해 이터레이터 인스턴스를 생성한다. 반환할 원소가 있는지
		 * 확인한 후 true이면 next()로 인출한다.
		 */
		...
		for (Student st : list2) {
			 ...
			 * 접근해야 한다. 삭제를 위해 입력한 이름과 Student 인스턴스에 저장된 name과

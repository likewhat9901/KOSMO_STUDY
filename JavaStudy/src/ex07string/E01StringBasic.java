...
public class E01StringBasic {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 - new를 이용한다.
		 - new를 통해 문자열 인스턴스를 생성하면 동일한 문자열이라도 항상 새로운 메모리를 할당한다.
		 */
		...
		/*
		 equals() 메서드
		 - Object 클래스에서 제공하는 메서드로 실제 저장된 문자열을 비교하도록 정의되어 있다.
		...
		/*
		 String 인스턴스 생성방법2
		 - "(double quotation)을 사용한다.
		 - 이 경우, 내용이 동일하다면 같은 주소를 사용한다.
		 - 즉, 새로운 메모리를 할당하지 않는다. 따라서 String 인스턴스는 방법2를 주로 사용한다.
		 */
		String str3 = "자바개발자";
		String str4 = "자바개발자";

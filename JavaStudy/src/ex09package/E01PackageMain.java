...
/*
 import 선언부: 현재 작성중인 클래스에서 다른 패키지에 정의된 클래스를 가져다 쓰기위한 선언으로,
...
public class E01PackageMain {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 방법1 : 하나의 클래스는 import하고, 다른 하나는 풀 패키지 경로를 기술한다.
		 */
		...
		/*
		 ...
		 난수 생성을 위해 별도의 인스턴스 생성없이 Math.random()을 호출할 수 있다.
		 */
		...
		/*
		 클래스 사용 시 패키지명까지 모두 입력한 상태로 메서드를 호출할 수 있다.
		 이경우에는 별도의 import가 필요하지 않다.
		 */
		System.out.println(

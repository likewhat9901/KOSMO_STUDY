...
class FruitSeller2{
	/*
	 두번째 버전에서는 멤버변수의 초깃값을 제거한다.
	 이경우 멤버상수는 에러가 발생하므로 final을 제거하여 일반적인 멤버변수로 변경한다.
...
public class E06FruitSalesMain2 {
	...
	public static void main(String[] args) {
		...
		seller1.initMembers(0, 100, 1000); // 돈, 사과개수, 사과가격
		//판매자2 : 사과 80개, 단가 500원
		FruitSeller2 seller2 = new FruitSeller2();
		seller2.initMembers(0, 80, 500); // 돈, 사과개수, 사과가격
		//구매자 : 보유금액 10,000원

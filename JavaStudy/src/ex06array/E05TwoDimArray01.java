...
public class E05TwoDimArray01 {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 초기화할 원소가 없는 부분은 null값으로 채워진다.
		 ※null값 : 아무것도 없는 값. 즉, 빈 값.
		  - 스페이스와 같은 공백문자 or 0과는 다르므로 명확한 의미를 인지해야 함.
		 */
		int[][] arr= {
				{1,2},
				{3,4,5},
		...
		/*
		 2차원 배열에서는 "배열변수.length"를 통해 행의 크기를 확인 가능.
		 */

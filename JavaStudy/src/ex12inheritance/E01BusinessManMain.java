 ...
 * 디폴트 생성자는 자동으로 삽입되고, 자식쪽에 super()도 자동으로 삽입될 수 있으므로
 * 생략가능한 코드가 존재한다.
class AA{
	public AA()	{}
}
 ...
 * 부모클래스를 자식클래스가 상속할때 extends를 사용한다.
 */
...
class BusinessMan extends Man {
	...
	public BusinessMan(String name, String company, String position) {
		/*
		 * 상속받은 자식클래스는 부모클래스의 생성자를 호출하여 부모인스턴스가 메모리에 먼저
		 * 생성되도록 해야한다. super()는 부모 클래스의 생성자를 호출해준다. 만약
		 * super()를 기술하지 않으면 컴파일러에 의해 자동으로 삽입되어 디폴트 생성자를
		 * 호출하게 된다.
		 */
	...
	public void tellYourInfo() {
		 ...
		 * 접근할 수 없다. private 멤버는 무조건 자신의 클래스 내부에서만 접근할 수 있다.
		 */
//		System.out.println("이름은 "+ name +" 입니다.");
		/*
		 * 직접 접근이 안되므로 public으로 선언된 메서드를 통해 간접적으로 접근해야 한다.
		 */
		tellYourName();
	}
}

...
public class Ex02PreDefineException1 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			/*
			 * 예외가 발생하는 지점.
			 * 해당 코드가 실행될 때 예외가 발생하게 되고, JVM이 예외 인스턴스를 생성해서
			 * 프로그램으로 전달한다.
			 */
			intArr[2] = 300;
			...
			/*
			 * JVM이 throw한 예외 인스턴스를 catch절에서 잡아 처리한다. 그러면
			 * 예외가 발생되어도 프로그램의 실행은 유지된다.
			 */
			//예외메세지1 : 개발자가 임의로 메세지를 출력
			System.out.println("예외가 발생했어요");
			//예외메세지2 : 간략한 설명을 출력
			System.out.println("예외메세지:"+ e.getMessage()); //간단한 메세지

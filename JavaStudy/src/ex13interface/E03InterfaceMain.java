 ...
 * - 추상클래스와 동일하게 상속을 목적으로 제작되므로 구현받은 하위클래스에서 반드시 추상메서드를 오버라이딩
 * 해야 한다.
...
//	public MyInterface1() {}
	...
	/*
	 * 멤버상수 : 인터페이스에 선언되는 변수는 상수로 선언된다. 따라서 대문자로 작성해야 한다.
	...
	/*
	 * 멤버메서드 : 메서드는 선언 시 추상메서드가 된다. 따라서 public abstract는
	 * 생략하는 것이 좋다.
	 */
...
class MyClass extends SimpleClass 
	...
	public void absFunc1() {
		System.out.println("absFunc1 구현부");
	}
	@Override
	public void absFunc2() {
		System.out.println("absFunc2 구현부");
	}
	/*
...
public class E03InterfaceMain {
	...
	public static void main(String[] args) {
		...
		my1.absFunc1();
		my1.absFunc2();
		//다른 클래스에 정의된 메서드를 호출하려면 형변환 후 호출해야 한다.
		((SimpleClass)my1).mySimple();
		
		//MyClass의 부모는 모두 3개이므로 다른 부모 2개도 모두 참조 가능하다.

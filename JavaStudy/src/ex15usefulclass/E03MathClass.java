...
/*
 * Java의 규칙 : java.lang 패키지 하위의 모든 클래스는 자동으로 import된다. 또한
 * 정의하는 모든 클래스는 Object를 상속하게 된다. 따라서 java.lang 패키지의 모든 클래스는
 * 별도의 선언없이 사용할 수 있고, Object에서 제공하는 메서드는 오버라이딩이 가능하다.
 */
import java.lang.*;
...
public class E03MathClass extends Object{
	...
	public static void main(String[] args) {
		 ...
		 * - 메서드는 static으로 선언되어 있어 인스턴스 생성없이 클래스명으로 즉시
		 * 호출할 수 있다.
		 */
		...
		System.out.println("Math.ceil:"+Math.ceil(3.14));
		...
		System.out.println("Math.round:"+Math.round(3.49999)); //소수점 첫째자리까지만 반올림
		...
		/*
		 * 0~1 사이의 실수를 랜덤하게 반환한다. 따라서 정수값을 만들고 싶다면
		 * 특정한 값을 곱해주면 된다.
		 */

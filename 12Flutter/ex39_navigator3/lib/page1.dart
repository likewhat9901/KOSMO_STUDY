...
class Page1 extends StatefulWidget {
  ...
  // 교안에 있는 생성자 코드 (구 버전에서 사용) => Page1({ Key? key, required this.data }) : super(key: key);
  /* 새로운 현재 버전의 생성자 코드로 required로 선언하면 필수사항임을 명시할 수 있다.
  즉, 생성자 호출시 반드시 값을 받아 초기화해야 한다. */
          ...
          children: [
            ...
            ElevatedButton(
              ...
              onPressed: () async {
                ...
                /* Page2를 스택에 추가한다. 즉 전환이 아니라 페이지를 추가하는 것.
                ...
                실행되지 않고 await하게 된다. 즉 Page2가 제거될때까지 대기했다가
                닫히는 순간 아래 코드가 실행된다.

 ...
 * 컨트롤러 클래스로 정의된다. 또한 사용을 위해 별도의 인스턴스를 생성할 필요없이
 * 스프링 컨테이너가 시작 시 자동으로 자바빈(인스턴스)를 생성해준다.
 */
@Controller
public class MainController {
	...
	public String sub() {
		 ...
		 * 구분하여 작성하면 됨. sub폴더 하위의 sub.jsp를 찾아 포워드.
		 */
		return "sub/sub";
	}
	...
	public String form3(PersonDTO personDTO) {
		 ...
		 * 개수와 상관없이 setter를 통해 한꺼번에 폼값을 받아 저장할 수 있다.

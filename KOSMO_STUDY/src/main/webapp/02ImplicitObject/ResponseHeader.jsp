...
// s는 아까 만든 날짜 포맷 객체
// .parse(문자열) : 문자열을 **날짜(Date 객체)**로 변환하는 메서드
long add_date = s.parse(request.getParameter("add_date")).getTime();
System.out.println("add_date="+add_date);
// 숫자 형식으로 전송된 값은 정수로 변환
...
<body>
	...
	getHeader() 메서드를 통해 출력하면 처음 입력한 헤더값만 출력되게 된다.
	따라서 이 경우에는 getHeaders()를 통해 해당값을 얻어온 후 반복해서 출력하면 각각의 값이 출력된다.
	*/

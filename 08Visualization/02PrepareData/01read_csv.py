...
print("df5: names=['삼장법사', '손오공', '저팔계', '사오정']\n", df5)
print('마지막 데이터', df5.loc[3, '사오정'])
print("="*30)

'''
names 옵션으로 컬럼을 지정하는 경우 데이터의 개수보다 적으면
끝에서부터 맞춰 적용된다. 즉, c0가 인덱스가 되고, c1~c3까지는 데이터가 된다.
'''
df6 = pd.read_csv(file_path, names=['유비', '관우', '장비'])
print("df6: names=['유비', '관우', '장비']\n", df6)

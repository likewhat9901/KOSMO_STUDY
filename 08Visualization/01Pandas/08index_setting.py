...
new_df2 = df.reindex(new_index1) # NaN은 Float타입이기 때문에 Float로 모두 자동 형변환
print(f"{'인덱스 재지정 후 출력:-^30'}")
'''
NaN : Not a Number의 이니셜로 직역하면 숫자가 아니다.
